...
#  Created by Genus(TM) Synthesis Solution 21.17-s066_1 on Fri Dec 12 13:48:26 EST 2025
...
set_input_delay -clock [get_clocks clk] -add_delay 0.01 [get_ports {S[0]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.01 [get_ports {S[1]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.01 [get_ports {S[2]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.01 [get_ports {S[3]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.01 [get_ports DR]
set_input_delay -clock [get_clocks clk] -add_delay 0.01 [get_ports DL]
...
set_max_fanout 5.000 [get_ports DL]
set_max_fanout 5.000 [get_ports DR]
set_max_fanout 5.000 [get_ports {S[3]}]
set_max_fanout 5.000 [get_ports {S[2]}]
set_max_fanout 5.000 [get_ports {S[1]}]
set_max_fanout 5.000 [get_ports {S[0]}]
...
set_drive 2.0 [get_ports DL]
set_drive 2.0 [get_ports DR]
set_drive 2.0 [get_ports {S[3]}]
set_drive 2.0 [get_ports {S[2]}]
set_drive 2.0 [get_ports {S[1]}]
set_drive 2.0 [get_ports {S[0]}]
